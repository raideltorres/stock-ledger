import type { Location, SoTransStatus, Customer, User } from "@/utils/types";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { cn, getInitials } from "@/lib/utils";
import { QrCode } from "../common/QrCode";

export interface SoTransHeaderProps {
  title?: string;
  orderId: string;
  location?: Location;
  user?: User;
...
export default function SoTransHeader({
        ...
        <div className="flex flex-col sm:flex-row items-start justify-start gap-4 sm:gap-10">
          ...
          <div className="flex flex-col items-start justify-start gap-3">
            ...
            <h1
              className={cn(
                "text-sm",
                status !== "SOLD" ? "text-blue-600" : "text-green-600"
              )}
            >
              {status}
            </h1>
